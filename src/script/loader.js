...
document.addEventListener('DOMContentLoaded', () => {
    ...
    imgLoad.on('done', instance => {
        ...
        tl.fromTo('.text1 span', {y: "100%"}, {y: "0", ease: "elastic.out(1,0.4)", duration: 1}, '<50%');
        tl.fromTo('.text2 span', {y: "-100%"}, {y: "0", ease: "elastic.out(1,0.4)", duration: 1}, '<50%');
        tl.fromTo('.text3 span', {x: "100%"}, {x: "0", ease: "elastic.out(1,0.4)", duration: 1}, '<50%');
        tl.fromTo('.text4 span', {y: "120%"}, {y: "0", ease: "elastic.out(1,0.4)", duration: 1}, '<50%');
